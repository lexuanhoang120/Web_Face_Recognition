...
# from fastapi import APIRouter, UploadFile, File, HTTPException, BackgroundTasks, Response, status, Form
# # noinspection PyUnresolvedReferences
# from packages.detection_for_add_target import detect_one_face
# # noinspection PyUnresolvedReferences
# from packages.embedding_face import EmbeddingFace
# from pydantic import BaseModel
#
# ABSOLUTELY_DIR = "D:/Documents/backendIdentifyHuman/main/"
#
# EMBEDDING_FACE = EmbeddingFace()
#
# router = APIRouter(
#     prefix="/face_recognition/list_information",
#     tags=['crud target tab on list tab'],
# )
#
...
#         return {
#             'data': {
#                 'data': target_information,
#                 'image_path': target_face_path
#             },
#             "errorCode": 0,
#             "message": "SUCCESS",
#             "errors": []
...
#                             cv2.imread(ABSOLUTELY_DIR + image_face_path
#                                        )
#                         )
#                     }
#             },
...
#     try:
#         id_list_information = int(open(ABSOLUTELY_DIR + 'more/id_list_information.txt').read()) + 1
#         open(ABSOLUTELY_DIR + 'more/id_list_information.txt', 'w').write(str(id_list_information))
...
#                 'list_name': information.list_name,
...
#
#
# def background_task_delete_image_path(image_path):
#     try:
#         os.remove(ABSOLUTELY_DIR + image_path)
#     except:
#         raise Exception("Have error while deleting")
#
#
...
#                     "embedding_face": EMBEDDING_FACE.embedding_face(
#                         cv2.imread(ABSOLUTELY_DIR + image_path)
#                     )
#                 }
#             ) for image_path in information.image_face_paths
#         ]
#
#         [
...
#         ]
#         [
#             background_task.add_task(background_task_delete_image_path, id_delete_image_path)
#             for id_delete_image_path in information.id_delete_image_paths
#         ]
#         return {
#             'data': {},
...
#         try:
#             os.remove(ABSOLUTELY_DIR + image_path["image_path"])
#         except:
#             continue
